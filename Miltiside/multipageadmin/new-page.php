        ...
        <div class="row">
            ...
            <div class="col-12 col-md-9 col-lg-9">
                ...
                <form action="">
                    ...
                    <div class="text-center mb-5">
                        <a style="background-color: #f1f1f1;" class="create-website create-website2"
                            href="add-single-page.php">Add a Single City Page</a>
                    </div>
                    <div class="text-center mb-5">
                        <a style="background-color: #f1f1f1;" class="create-website create-website2"
                            href="country.php">Add a Country and City </a>
                    </div>
                </form>
            </div>
