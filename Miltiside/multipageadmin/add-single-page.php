                            ...
                            <div class="single-filed">
                                ...
                                <div class="right services">
                                    <select name="services[]" class="country-name form-control" multiple>
                                        ...
                                        <option value='Mobile App development services'>Mobile App development services
                                        </option>
                                    </select>
...
dropDown1item.forEach((element) => {
    element.addEventListener("click", (e) => {
        let dropDownChip =
            `<span class="tag-single"><i class="fa-solid fa-xmark" onClick="deleteChipData1('${e.target.innerHTML}')"></i> &nbsp; ${e.target.innerHTML}</span>`
...
dropDown2item.forEach((element) => {
    element.addEventListener("click", (e) => {
        let dropDownChip =
            `<span class="tag-single"><i class="fa-solid fa-xmark" onClick="deleteChipData2('${e.target.innerHTML}')"></i> &nbsp; ${e.target.innerHTML}</span>`
...
$(document).ready(function() {
    ...
    $('#all-select').click(function() {
        ...
        if (madharchod.is(':checked')) {
            $.each($(madharchod.parent().siblings('.country-name')[0]).find('option'), function(
